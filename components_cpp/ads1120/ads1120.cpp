...
esp_err_t ADS1120::writeRegisterMasked(uint8_t value, uint8_t mask, uint8_t address)
{
...
esp_err_t ADS1120::setMultiplexer(uint8_t value)
{
  /* Set multiplexer
  ...
  */
  ...
  return writeRegisterMasked(value, ADS1120_REG_MASK_MUX, ADS1120_CONFIG_REG0_ADDRESS);
}

esp_err_t ADS1120::setGain(uint8_t gain)
{
...
esp_err_t ADS1120::setPGAbypass(bool value)
{
  /* Bypasses the PGA if true.
     PGA can only be disabled for gains 1, 2, 4.
  */
  return writeRegisterMasked(value, ADS1120_REG_MASK_PGA_BYPASS, ADS1120_CONFIG_REG0_ADDRESS);
}

esp_err_t ADS1120::setDataRate(uint8_t value)
{
  ...
  return writeRegisterMasked(value, ADS1120_REG_MASK_DATARATE, ADS1120_CONFIG_REG1_ADDRESS);
}

esp_err_t ADS1120::setOpMode(uint8_t value)
{
  ...
  */
  ...
  return writeRegisterMasked(value, ADS1120_REG_MASK_OP_MODE, ADS1120_CONFIG_REG1_ADDRESS);
}

esp_err_t ADS1120::setConversionMode(uint8_t value)
{
  ...
  */
  ...
  return writeRegisterMasked(value, ADS1120_REG_MASK_CONV_MODE, ADS1120_CONFIG_REG1_ADDRESS);
}

esp_err_t ADS1120::setTemperatureMode(uint8_t value)
{
  ...
  */
  ...
  value = value << 1; // Shift to match with mask
  return writeRegisterMasked(value, ADS1120_REG_MASK_TEMP_MODE, ADS1120_CONFIG_REG1_ADDRESS);
}

esp_err_t ADS1120::setBurnoutCurrentSources(bool value)
{
  /* Turns the 10uA burn-out current sources on or off. */
  return writeRegisterMasked(value, ADS1120_REG_MASK_BURNOUT_SOURCES, ADS1120_CONFIG_REG1_ADDRESS);
}

esp_err_t ADS1120::setVoltageRef(uint8_t value)
{
  ...
  */
  ...
  return writeRegisterMasked(value, ADS1120_REG_MASK_VOLTAGE_REF, ADS1120_CONFIG_REG2_ADDRESS);
}

esp_err_t ADS1120::setFIR(uint8_t value)
{
  ...
  */
  ...
  value = value << 4; // Shift to match with mask
  return writeRegisterMasked(value, ADS1120_REG_MASK_FIR_CONF, ADS1120_CONFIG_REG2_ADDRESS);
}

esp_err_t ADS1120::setPowerSwitch(uint8_t value)
{
  ...
  */
  ...
  value = value << 3; // Shift to match with mask
  return writeRegisterMasked(value, ADS1120_REG_MASK_PWR_SWITCH, ADS1120_CONFIG_REG2_ADDRESS);
}

esp_err_t ADS1120::setIDACcurrent(uint8_t value)
{
  ...
  */
  ...
  return writeRegisterMasked(value, ADS1120_REG_MASK_IDAC_CURRENT, ADS1120_CONFIG_REG2_ADDRESS);
}

esp_err_t ADS1120::setIDAC1routing(uint8_t value)
{
  ...
  */
  ...
  value = value << 5; // Shift to match with mask
  return writeRegisterMasked(value, ADS1120_REG_MASK_IDAC1_ROUTING, ADS1120_CONFIG_REG3_ADDRESS);
}

esp_err_t ADS1120::setIDAC2routing(uint8_t value)
{
  ...
  */
  ...
  value = value << 2; // Shift to match with mask
  return writeRegisterMasked(value, ADS1120_REG_MASK_IDAC2_ROUTING, ADS1120_CONFIG_REG3_ADDRESS);
}

esp_err_t ADS1120::setDRDYmode(uint8_t value)
{
 ...
 */
  ...
  value = value << 1; // Shift to match with mask
  return writeRegisterMasked(value, ADS1120_REG_MASK_DRDY_MODE, ADS1120_CONFIG_REG3_ADDRESS);
}
